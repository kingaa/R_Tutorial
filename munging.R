...
#' For your convenience, the [**R** codes for this document are provided in a script](http://raw.githubusercontent.com/kingaa/R_Tutorial/master/munging.R) which you can download, edit, and run.
#' 
